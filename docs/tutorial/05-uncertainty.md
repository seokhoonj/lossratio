...
4장은 빈 칸에 **하나의 숫자**를 채웠다 — 최근 코호트의 예측 손해율을 ED는
...
4장에서 CL이 최근 코호트에 위험하다고 했다. CV는 그 위험을 **숫자로
경고**한다. 가장 최근 코호트의 CL 예측치 0.86 옆에는 CV 약 23%가 붙는다 —
...
#> 최근 코호트 (2025-4분기):  proj 0.86,  ratio_cv 21.2%
```
