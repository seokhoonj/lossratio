...
이렇게 상쇄되므로, 5장에서 손해율 밴드가 보험료를 *알려진 값*으로 두는 것이
...
#> ╞════════╪═════════╪═════════╪═════════╪═════════╡
#> │ 28->29 ┆ 1.03706 ┆ 1.03567 ┆ 1.00135 ┆ 0.00135 │
...
너머로 *동결해 내밀* 값입니다. 담보마다 수준이 다른 게 자연스럽습니다:
...
#> │ INPATIENT ┆ 36                ┆ 0.416596         ┆ stable     │
#> │ SURGERY   ┆ 36                ┆ 1.509562         ┆ stable     │
#> └───────────┴───────────────────┴──────────────────┴────────────┘
```
...
#> │ duration ┆ loss     ┆ premium  ┆ ratio    │
#> ╞══════════╪══════════╪══════════╪══════════╡
#> │ 37       ┆ 1.7263e9 ┆ 1.1436e9 ┆ 1.509562 │
#> │ 38       ┆ 1.7796e9 ┆ 1.1789e9 ┆ 1.509562 │
#> │ 39       ┆ 1.8345e9 ┆ 1.2152e9 ┆ 1.509562 │
#> └──────────┴──────────┴──────────┴──────────┘
```
