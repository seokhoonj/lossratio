...
* - CL
  - 누적 손해 x ATA 인자
  - 고전적 대안. 발전이 일관될 때 정확, 최근 코호트엔 위험
* - SA
  - 전환 전 ED + 전환 후 CL
...
ED는 초기 구간에서 안정적이고, CL은 발전이 일관된 구간에서 손해의 진전을
...
- **ED** — 발전 대신 **노출(보험료)에 고정**한다. 게다가 강도 `g_k`를
...
* - CL
  - 충분히 발전해 진전 패턴이 코호트 간 일관될 때. 최근 코호트엔 위험
* - SA
