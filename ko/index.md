...
| [`build_total()`](https://seokhoonj.github.io/lossratio/ko/reference/build_total.md) | `total` | portfolio total (0D, per group) | High-level comparison across groups |
...
GPL (\>= 2). See
[LICENSE.md](https://seokhoonj.github.io/lossratio/ko/LICENSE.md).
